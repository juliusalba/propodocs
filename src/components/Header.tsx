                ...
                <div className="max-w-md mx-auto">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-12 pr-4 py-3 bg-white border-2 border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:border-[#7A1E1E] focus:ring-4 focus:ring-red-100 transition-all outline-none shadow-sm"
                        />
                    </div>
                </div>
            </div>
